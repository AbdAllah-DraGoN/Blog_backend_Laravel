...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image/x-icon" href="/php/learn-from-english/imgs/programing.png" href="" />
    ...
    <div class="min-h-full">
        <nav class="bg-gray-800">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            ...
                            <img class="size-8" src="../imgs/programing.png" alt="Your Company">
              ...
              -->
                                <div class="absolute transform opacity-0 scale-95 right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none"
                            ...
                            <div class="ml-3">
                                ...
                                <form method="POST" action=<?= base_uri('/session') ?> class="flex align-center">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button href=<?= base_uri('/logout') ?>
